...
function Kongsberg() {
    const stats = [
        {
            data: "2",
            title: "Teams I was apart of (Shell and Chevron"
        },
        {
            data: "15",
            title: "Dashboards and Tables Improved"
        },
        {
            data: "5",
            title: "Developers on Team"
        },
...
<section class="block">
  <div class="bg-[#D71739] text-white">
  ...
  <div class="">
    <div class="py-12 md:py-16 lg:py-20 px-5 md:px-10">
      <div class="relative grid w-full items-start justify-start max-[991px]:flex-col max-[991px]:flex grid-cols-[480px] lg:grid-cols-[0.5fr_0.75fr_480px] gap-4 mx-auto max-w-7xl">
        ...
        <img src={Kongs4}alt="" class="absolute right-0 bottom-0 inline-block object-cover max-[991px]:relative max-[991px]:mt-12 max-[991px]:max-w-[480px] h-auto lg:h-[480px] w-full lg:w-[480px]"/>
      </div>
    </div>
  </div>
</section>
              ...
              <div class="max-[991px]:max-w-[720px]">
                ...
                <div class="mb-6 max-w-[528px] md:mb-10 lg:mb-12">
                  ...
                  <ul class="list-disc pl-10 mt-5 mb-6 max-w-[528px] md:mb-10 lg:mb-22  text-[#636262] ">
                    <li>Cloud-Architecture, Complete with Industry-Grade APIs</li>
                    <li>What-if Scenario Analysis</li>
                    <li>Hybrid Analytics and Machine Learning Leveraging Synthetic Data </li>
                </ul>
  ...
  <div class="py-6 md:py-14 lg:py-12 mx-auto w-full max-w-7xl px-5 md:px-10">
    <div class="mx-auto flex-col flex max-w-3xl items-center text-center mb-8 md:mb-12 lg:mb-16">
      <div class="text-center">
        <h2 class="font-bold text-3xl md:text-5xl">Why Organizations Rally Around Digital Twin</h2>
      </div>
    </div>
    <div class="relative flex-col flex items-center justify-center bg-contain bg-center bg-no-repeat pt-10 " styles="background-image: url('https://assets.website-files.com/6458c625291a94a195e6cf3a/648825fca218588cb636c341_Group%2048114.png');">
      <div class="relative flex w-full justify-around gap-4">
        <a class="relative flex-1 flex flex-col max-w-full items-start gap-2 border border-solid border-[#d9d9d9] bg-[#2C3084] text-white p-6 text-left align-top max-[479px]:block rounded-md" href="#w-tabs-2-data-w-pane-0">
          <h5 class="text-xl font-bold">Support easier and more engaging work for staff in the field and in the office</h5>
          <div class="text-sm sm:text-sm"> </div>
        </a>
        <a class="relative flex-col flex-1 flex max-w-full items-start gap-2 border border-solid border-[#d9d9d9] bg-[#2C3084] text-white  p-6 text-left align-top max-[479px]:block rounded-md" tabindex="-1" href="#w-tabs-2-data-w-pane-1">
          <h5 class="text-xl font-bold">Link directly to asset performance objectives</h5>
          <div class="text-sm sm:text-sm"></div>
        </a>
        <a class="relative flex-col flex-1 flex max-w-full items-start gap-2 border border-solid border-[#d9d9d9] bg-[#2C3084] text-white p-6 text-left align-top max-[479px]:block rounded-md" tabindex="-1" href="#w-tabs-2-data-w-pane-2">
          <h5 class="text-xl font-bold">Enable the future of work</h5>
          <div class="text-sm sm:text-sm"></div>
        </a>
      </div>
      ...
      <div class="px-5 md:px-10">
        <div class="mx-auto w-full max-w-7xl">
          <div class="py-16 md:py-24 lg:py-32">
            <div class="grid grid-cols-1 items-center gap-8 max-[991px]:justify-items-start sm:gap-20 lg:grid-cols-2">
              <div class="max-[991px]:max-w-[720px]">
                <h3 class="mb-4 mt-6 text-2xl font-bold md:text-3xl">User Flow for Performance Dashboards</h3>
                <div class="mb-6 max-w-[528px] md:mb-10 lg:mb-12">
                  <p class="text-xl text-[#636262]">I was responsible for creating a user flows when a new component request was made. </p>
                  <ul class="list-disc pl-10 mt-5 mb-6 max-w-[528px] md:mb-10 lg:mb-22  text-[#636262] ">
                    <li>Reinvent Digital Customer Experience</li>
                    <li>Who will the user of this new feature/dashboard be used by?</li>
              ...
              <div class="">
                <img src={Kongs1} alt="Features Image" class="mx-auto inline-block h-full w-full max-w-[640px] rounded-2xl object-cover" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="mx-auto w-full max-w-7xl">
          <div class="py-16 md:py-24 lg:py-32">
            <div class="grid grid-cols-1 items-center gap-8 max-[991px]:justify-items-start sm:gap-20 lg:grid-cols-2">
              ...
              <div class="">
                <img src={Kongs3} alt="CTA Card Image" class="mx-auto inline-block h-full w-full max-w-[640px] rounded-2xl object-cover" />
              </div>
            </div>
          </div>
        </div>
...
The process consists of creating a digital twin of the real-life interior of the designated building and is offered as a custom solution for each client.</p>
              ...
              <div class="">
                <img src={Kongs7} alt="" class="mx-auto inline-block h-full w-full max-w-[640px] object-cover" />
              </div>
            </div>
          </div>
        </div>
