                    ...
                    <ul className="mt-12 gap-y-6 gap-x-12 items-center md:flex lg:gap-x-0 lg:mt-0">
                        {
                            contactMethods.map((item, idx) => (
                                <li key={idx} className="space-y-3 border-t py-6 md:max-w-sm md:py-0 md:border-t-0 lg:border-l lg:px-12 lg:max-w-none">
                                    <div className="w-12 h-12 rounded-full border flex items-center justify-center text-red-300">
                                        {item.icon}
                                    </div>
                                    ...
                                    <a href={item.link.href} className="flex items-center gap-1 text-sm text-red-300 duration-150 hover:text-indigo-400 font-medium">
                                        {item.link.name}
