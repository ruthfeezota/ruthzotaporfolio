...
function Services() {
  ...
  return (
    ...
    <div className="max-w-screen-xl mx-auto px-4  md:px-8">
        ...
        <div className='absolute inset-0 blur-[118px] max-w-lg h-[400px] mx-auto sm:max-w-3xl sm:h-[400px] animate-pulse' style={{ background: "linear-gradient(106.89deg, rgba(192, 132, 252, 0.11) 15.73%, rgb(252,165,165) 15.74%, rgba(232, 121, 249, 0.26) 56.49%, rgba(79, 70, 229, 0.4) 115.91%)" }}></div>
    </div>
