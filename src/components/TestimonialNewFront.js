      ...
      <div class="container mx-auto xl:px-32">
        <div class="flex grid items-center lg:grid-cols-2">
          <div class="mb-12 md:mt-12 lg:mt-0 lg:mb-0">
            <div
              class="relative z-[1] block rounded-lg  px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] backdrop-blur-[25px] dark:bg-[hsla(0,0%,5%,0.4)] dark:shadow-black/20 md:px-12 lg:-mr-14"  data-aos="fade-up">
              <h2 class="mb-2 text-3xl font-bold text-primary dark:text-primary-400 text-white">
              Boomtown Coffee
              </h2>
              <p class="mb-4 font-semibold text-red-300">Coffee Shop Houston</p>
              <p class="mb-6 text-neutral-100 dark:text-neutral-300">
              Our coffee shop's website got a fantastic makeover, thanks to Ruth and her design and development skills!
              </p>
              <p class="mb-6 text-neutral-100 dark:text-neutral-300">
          ...
          <div class="md:mb-12 lg:mb-0"  data-aos="fade-up">
