...
function Projects() {
	...
	return (
		<section
			className="py-4 text-white bg-[#E0DFDD] questrial-regular"
			id="Project"
		>
			<div
			...
			>
				<div className="relative max-w-xl mx-auto sm:text-center">
					<h3 className="text-5xl text-black mt-10 font-bold uppercase">Portfolio</h3>
			...
			<div
				class="container mx-auto px-5 py-2 lg:px-24 lg:pt-16"
				data-aos="fade-up"
			>
				<div class="-m-1 flex flex-wrap md:-m-2" data-aos="fade-up">
					...
					<div class="flex w-1/2 flex-wrap ">
						...
						<div class="w-1/2 outline-none shadow-md focus:shadow-none focus:ring-2 ring-offset-2  transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110  duration-300">
							<a
								href="https://www.leafglobalfintech.com"
								target="_blank"
								rel="noreferrer"
							>
								<img
