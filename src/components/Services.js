			...
			>
				<div className="relative max-w-2xl mx-auto sm:text-center">
					<div className="relative z-10">
						<h3 className="text-black text-3xl uppercase font-extrabold sm:text-4xl mt-20">
							Services
						</h3>
						<p className="mt-3 text-black">
							I possess expertise in a wide range of frontend
				...
				<div className="relative mt-12" data-aos="fade-up">
					<ul className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 ">
						{features.map((item, idx) => (
							<li
								key={idx}
								className="bg-[#E0DFDD] border-[1px] space-y-3 p-4 border-[#E4A4BD] duration-150 outline-none shadow-sm focus:ring-2 ring-offset-2 ring-lime-400 sm:mt-0 sm:ml-3 sm:w-auto transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110"
							>
