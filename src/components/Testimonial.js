...
<section class="bg-[#E0DFDD]"  data-aos="zoom-in-down">
  ...
  <div class="mx-auto w-full max-w-7xl px-5 py-8 md:px-10 md:py-6 lg:py-5 questrial-regular uppercase">
<div class="flex flex-col items-center">
      <div class="mb-8 w-full md:mb-12 lg:mb-16 flex items-center justify-center">
        <div class="max-w-[800px] text-center" data-aos="zoom-in-down">
          <h2 class="text-2xl font-extrabold sm:text-3xl text-black">See what my clients are saying</h2>
          <div class="mx-auto w-full max-w-lg py-2" >
            <p class="tracking-[0.2px] text-black"> Past clients provides feedback from their experience with my professionalism and quality of my work.</p>
          </div>
        </div>
      </div>
      <div class="mb-12 grid grid-cols-1 justify-items-center gap-6 sm:grid-cols-2 md:mb-16 md:grid-cols-3 lg:mb-20 ">
        <div class="grid gap-6 bg-[#E0DFDD] border-[1px] border-black p-8">
          ...
          <div class="flex items-center gap-4">
            ...
            <div class="flex flex-col items-start text-sm">
              ...
              <p class="tracking-[0.2px] text-black">Founder - JOSYS</p>
            </div>
          </div>
        </div>
        <div class="grid gap-6 bg-[#E0DFDD] border-[1px] border-black p-8 py-10">
          <div class="flex items-center justify-between text-[#fff49b]">
            <div class="flex text-[#fff49b]">
              <div class="mr-1 w-3.5 flex-none">
                <svg width="14" height="13" viewBox="0 0 14 13" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="flex items-center gap-4">
            ...
            <div class="flex flex-col items-start text-sm">
              ...
              <p class="tracking-[0.2px] text-black">Business Owner - Bettersheabutter.com</p>
            </div>
          </div>
        </div>
        <div class="grid gap-6 bg-[#E0DFDD] border-[1px]
         border-black p-8">
          <div class="flex items-center justify-between text-[#fff49b]">
            <div class="flex text-[#fff49b]">
              <div class="mr-1 w-3.5 flex-none">
          ...
          <div class="flex items-center gap-4">
            ...
            <div class="flex flex-col items-start text-sm">
              ...
              <p class="tracking-[0.2px] text-black">Senior UI Engineer - TechCrunch</p>
            </div>
          </div>
        </div>
      </div>
