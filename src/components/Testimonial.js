...
<section class="bg-[#CBC7C1]"  data-aos="zoom-in-down">

  <div class="mx-auto w-full max-w-5xl px-5 py-8 md:px-10 md:py-6 lg:py-5 questrial-regular uppercase">
<div class="flex flex-col items-center" >
      ...
      <div class="mb-12 grid grid-cols-1 justify-items-center gap-10 sm:grid-cols-2 md:mb-16 md:grid-cols-3 lg:mb-20">
        <div class="grid gap-6 bg-[#CBC7C1] border-2 border-black p-8">
